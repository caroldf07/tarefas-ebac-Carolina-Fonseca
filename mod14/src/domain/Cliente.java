...
public class Cliente {
     ...
     */
    public Cliente(String nome, String cpf, String telefone, String endereco, String cidade,
                   String estado) {
        this.nome = nome;
        this.cpf = Long.valueOf(
     ...
     * @return Retorna verdadeiro caso o cliente especificado seja igual ao outro e falso caso seja diferente
     */
    @Override
