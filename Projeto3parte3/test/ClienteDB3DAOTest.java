...
import main.java.br.com.rpires.dao.ClienteDB3DAO;
...
class ClienteDB3DAOTest {

    private final IClienteDAO<ClienteJpa2> clienteDao;

    public ClienteDB3DAOTest() {
        clienteDao = new ClienteDB3DAO();
    }
