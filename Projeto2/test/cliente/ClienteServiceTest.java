...
public class ClienteServiceTest {
  ...
  void naoDeveCadastraUmCliente() {
    RuntimeException exception =
        assertThrows(UnsupportedOperationException.class, () -> clienteService.cadastrar(cliente));
  ...
  void naoDeveEncontrarUmCliente() {
    RuntimeException exception =
        assertThrows(
            UnsupportedOperationException.class, () -> clienteService.procurar(cliente.getCpf()));
    assertEquals("Não pode realizar operação sem o banco cadastrado", exception.getMessage());
  }
  ...
  void naoDeveAtualizarUmCliente() {
    RuntimeException exception =
        assertThrows(
            UnsupportedOperationException.class, () -> clienteService.atualizar(cliente.getCpf()));
    assertEquals("Não pode realizar operação sem o banco cadastrado", exception.getMessage());
  }
  ...
  void naoDeveDeletarUmCliente() {
    RuntimeException exception =
        assertThrows(
            UnsupportedOperationException.class, () -> clienteService.deletar(cliente.getCpf()));
    assertEquals("Não pode realizar operação sem o banco cadastrado", exception.getMessage());
  }
}
