...
public class ClienteController implements Serializable {
  ...
  public void init() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar listar os clientes"));
    }
  }
  ...
  public void edit(Cliente cliente) {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar excluir o cliente"));
    }
  }
  ...
  public void add() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar criar o cliente"));
    }
  }
  ...
  public void update() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar atualizar o cliente"));
    }
  }
