 ...
 * @project tarefas-ebac-Carolina-Fonseca Atividade de filtrar listas do módulo 22 - Streams e
 *     Expressões Lambdas // Refatorações por conta do módulo 23
 */
public class Streams {

  /**
   * Ler uma lista de pessoas no console. Exemplo: Nome - genero, Nome - genero,... Criar outra
   * lista somente com as mulheres dessa lista Printar a lista final
   */
