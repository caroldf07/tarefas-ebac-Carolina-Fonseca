...
public class ExercicioGenerics {
    public static void main(String[] args) {
        Audi audi1 = AudiBuilder.builder().potencia(10L).cor("verde").quantidadeMaxCombustivel(10L)
                .tipoCombustivel("gasolina").build();
        Audi audi2 = AudiBuilder.builder().potencia(20L).cor("azul").quantidadeMaxCombustivel(10L)
                .tipoCombustivel("gasolina").build();

        Tesla tesla1 =
                TeslaBuilder.builder().potencia(30L).cor("preto").quantidadeMaxCombustivel(10L)
                        .tipoCombustivel("gasolina").build();
        Tesla tesla2 =
                TeslaBuilder.builder().potencia(40L).cor("vermelho").quantidadeMaxCombustivel(10L)
                        .tipoCombustivel("gasolina").build();
