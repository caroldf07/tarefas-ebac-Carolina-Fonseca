...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
  ...
  @Override
  protected void setParametrosQueryInsercao(PreparedStatement stmInsert, Venda entity)
      throws SQLException {
  ...
  private StringBuilder sqlBaseSelect() {
    ...
    sb.append(
        "C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C"
            + ".ESTADO,C.PAIS ");
  ...
  private void setParametrosQueryInsercaoProdQuant(
      PreparedStatement stm, Venda venda, ProdutoQuantidade prod) throws SQLException {
