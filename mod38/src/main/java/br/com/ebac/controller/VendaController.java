...
public class VendaController implements Serializable {
  ...
  public void init() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar listar as vendas"));
    }
  }
  ...
  public void delete(Venda venda) {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar cancelar a venda"));
    }
  }
  ...
  public void finalizar(Venda venda) {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar finalizar a venda"));
    }
  }
  ...
  public void add() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar cadastrar a venda"));
    }
  }
  ...
  public void update() {
    try {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("growl", new FacesMessage("Erro ao tentar atualizar a venda"));
    }
  }

  public void adicionarProduto() {
    Optional<ProdutoQuantidade> prodOp =
        this.venda.getProdutos().stream()
            .filter(
                prodF -> prodF.getProduto().getCodigo().equals(this.produtoSelecionado.getCodigo()))
            .findFirst();
  ...
  public void onRowCancel(RowEditEvent<ProdutoQuantidade> event) {
    FacesMessage msg =
        new FacesMessage("Edit Cancelled", String.valueOf(event.getObject().getId()));
